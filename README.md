...
In this project, a behavior and path planning agent is programmed to drive in a simulated environment. The agent represents a car in a simulated engironment of a race track where other agent-cars are present. 
...
The original repo of the project without implementation of the agent behavior is availabl [here]().
